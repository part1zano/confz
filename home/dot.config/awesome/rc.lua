...
globalkeys = awful.util.table.join(
	...
	awful.key({                   }, "Print", function () awful.util.spawn( "scrot '%Y-%m-%d_%H%M%S.png' -e 'mv $f ~/shots'", false) end),
	awful.key({ modkey,           }, "Print", function () awful.util.spawn( "scrot latest.png -e 'gimp $f'", false ) end),
